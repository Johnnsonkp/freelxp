...
- [ ] Content creation calendar feature
      - 1. Calendar integrates with google cal
      - 2. Allows user to enter events (google cal style)
      - 3. Allows user to enter tasks (todo list style)
      - 4. Allows to schedule video meetings w/ google
      - 5. Pomodorro timer integration
      - Optional: study ambient music
