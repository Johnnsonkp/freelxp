    ...
    <article>
      ...
      <header id="headerContent" className="py-3 md:py-3 md:pb-10 mt-[-5px] h-full md:h-auto">
        ...
        <div className="flex justify-around max-w-7xl mx-auto sm:flex-col sm:gap-10 md:flex-row md:gap-0">
          ...
          <div className="container max-w-2xl mx-auto px-0 flex items-end justify-end flex-[0.4]">
            <div>
              <p id="desc" className="mt-0 text-white/75 text-2xl font-medium">{post.metadata.description}</p>
