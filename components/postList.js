...
export default function postList({ posts }) {
  ...
  return (
    <>
      ...
      {posts && posts.some(post => post.category === "Blog") && ( <section className="container max-w-6xl mx-auto px-4">
        <h2 className="text-2xl font-bold dark:text-white text-black tracking-tight">Blog Posts</h2>
      ...
      {posts && posts.some(post => post.category === "YouTube") && ( <section className="container max-w-6xl mx-auto px-4">
