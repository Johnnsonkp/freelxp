      ...
      {data && data.map((item, index) => (
        <div className="space-y-2" key={index}>
          <p className="text-foreground flex items-center gap-1 ">
            <div className={`w-7 h-6 border border-accent dark:border-darkBorder border-transparent rounded-full flex items-center justify-center ${item?.iconPadding ? 'px-1' : ''}`}>
