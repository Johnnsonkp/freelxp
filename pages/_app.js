  ...
  return (
    <>
      ...
      <main id="root" className="flex flex-col gap-1">
        ...
        <div className='flex gap-11 desk-sm:justify-between'>
          <SideNav />

          <div className='ml-auto mr-auto min-h-screen max-w-8xl desk-sm:pt-0 desk-sm:ml-14 desk-md:ml-14 desk-lg:ml-14'>
            <Component {...pageProps} />
          </div>
